...
import org.citydb.core.operation.importer.database.content.DBAddress;
import org.citydb.core.operation.importer.database.content.DBAddressToBridge;
import org.citydb.core.operation.importer.database.content.DBAddressToBuilding;
import org.citydb.core.operation.importer.database.content.DBAppearToSurfaceData;
import org.citydb.core.operation.importer.database.content.DBAppearance;
import org.citydb.core.operation.importer.database.content.DBBridge;
import org.citydb.core.operation.importer.database.content.DBBridgeConstrElement;
import org.citydb.core.operation.importer.database.content.DBBridgeFurniture;
import org.citydb.core.operation.importer.database.content.DBBridgeInstallation;
import org.citydb.core.operation.importer.database.content.DBBridgeOpenToThemSrf;
import org.citydb.core.operation.importer.database.content.DBBridgeOpening;
import org.citydb.core.operation.importer.database.content.DBBridgeRoom;
import org.citydb.core.operation.importer.database.content.DBBridgeThematicSurface;
import org.citydb.core.operation.importer.database.content.DBBuilding;
import org.citydb.core.operation.importer.database.content.DBBuildingFurniture;
import org.citydb.core.operation.importer.database.content.DBBuildingInstallation;
import org.citydb.core.operation.importer.database.content.DBCityFurniture;
import org.citydb.core.operation.importer.database.content.DBCityObject;
import org.citydb.core.operation.importer.database.content.DBCityObjectGenericAttrib;
import org.citydb.core.operation.importer.database.content.DBCityObjectGroup;
import org.citydb.core.operation.importer.database.content.DBExternalReference;
import org.citydb.core.operation.importer.database.content.DBGenericCityObject;
import org.citydb.core.operation.importer.database.content.DBImplicitGeometry;
import org.citydb.core.operation.importer.database.content.DBImporter;
import org.citydb.core.operation.importer.database.content.DBLandUse;
import org.citydb.core.operation.importer.database.content.DBOpening;
import org.citydb.core.operation.importer.database.content.DBOpeningToThemSurface;
import org.citydb.core.operation.importer.database.content.DBPlantCover;
import org.citydb.core.operation.importer.database.content.DBReliefComponent;
import org.citydb.core.operation.importer.database.content.DBReliefFeatToRelComp;
import org.citydb.core.operation.importer.database.content.DBReliefFeature;
import org.citydb.core.operation.importer.database.content.DBRoom;
import org.citydb.core.operation.importer.database.content.DBSolitaryVegetatObject;
import org.citydb.core.operation.importer.database.content.DBSurfaceData;
import org.citydb.core.operation.importer.database.content.DBSurfaceGeometry;
import org.citydb.core.operation.importer.database.content.DBTexImage;
import org.citydb.core.operation.importer.database.content.DBTextureParam;
import org.citydb.core.operation.importer.database.content.DBThematicSurface;
import org.citydb.core.operation.importer.database.content.DBTrafficArea;
import org.citydb.core.operation.importer.database.content.DBTransportationComplex;
import org.citydb.core.operation.importer.database.content.DBTunnel;
import org.citydb.core.operation.importer.database.content.DBTunnelFurniture;
import org.citydb.core.operation.importer.database.content.DBTunnelHollowSpace;
import org.citydb.core.operation.importer.database.content.DBTunnelInstallation;
import org.citydb.core.operation.importer.database.content.DBTunnelOpenToThemSrf;
import org.citydb.core.operation.importer.database.content.DBTunnelOpening;
import org.citydb.core.operation.importer.database.content.DBTunnelThematicSurface;
import org.citydb.core.operation.importer.database.content.DBWaterBodToWaterBndSrf;
import org.citydb.core.operation.importer.database.content.DBWaterBody;
import org.citydb.core.operation.importer.database.content.DBWaterBoundarySurface;
