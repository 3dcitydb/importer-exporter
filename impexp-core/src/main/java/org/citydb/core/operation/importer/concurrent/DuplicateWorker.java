...
public class DuplicateWorker extends Worker<CityGML> implements EventHandler {
    ...
    public DuplicateWorker(DuplicateLogger duplicateLogger, CityGMLFilter filter) throws SQLException {
