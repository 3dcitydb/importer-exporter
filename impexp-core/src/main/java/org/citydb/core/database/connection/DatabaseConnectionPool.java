...
public class DatabaseConnectionPool implements ConnectionManager {
    ...
    public synchronized void connect(DatabaseConnection connection) throws DatabaseConfigurationException, DatabaseVersionException, SQLException {
        ...
        if (connection.getValidatorClassName() != null)
            properties.setValidatorClassName(connection.getValidatorClassName());
        if (connection.getTimeBetweenEvictionRunsMillis() != null)
            properties.setTimeBetweenEvictionRunsMillis(connection.getTimeBetweenEvictionRunsMillis());
        if (connection.getNumTestsPerEvictionRun() != null)
            properties.setNumTestsPerEvictionRun(connection.getNumTestsPerEvictionRun());
        if (connection.getMinEvictableIdleTimeMillis() != null)
            properties.setMinEvictableIdleTimeMillis(connection.getMinEvictableIdleTimeMillis());
        if (connection.getRemoveAbandoned() != null) properties.setRemoveAbandoned(connection.getRemoveAbandoned());
        if (connection.getRemoveAbandonedTimeout() != null)
            properties.setRemoveAbandonedTimeout(connection.getRemoveAbandonedTimeout());
        ...
        if (connection.getConnectionProperties() != null)
            properties.setConnectionProperties(connection.getConnectionProperties());
        if (connection.getInitSQL() != null) properties.setInitSQL(connection.getInitSQL());
        if (connection.getValidationInterval() != null)
            properties.setValidationInterval(connection.getValidationInterval());
        ...
        if (connection.getAbandonWhenPercentageFull() != null)
            properties.setAbandonWhenPercentageFull(connection.getAbandonWhenPercentageFull());
        ...
        // pool maintenance
        properties.setJdbcInterceptors("org.citydb.core.database.connection.ConcurrentStatementFinalizer");
