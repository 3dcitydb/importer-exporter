...
@XmlType(name = "injectedComplexAttribute")
public class InjectedComplexAttribute extends ComplexAttribute implements InjectedProperty {
	@XmlAttribute
	...
	protected InjectedComplexAttribute() {
	}
    
    public InjectedComplexAttribute(String path, AppSchema schema) {
    	super(path, schema);
    }
