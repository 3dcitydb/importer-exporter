...
public class GMLConverter {
	...
	public PointProperty getPointProperty(GeometryObject geomObj) {
		return getPointProperty(geomObj, false);
	}
	...
	public MultiPoint getMultiPoint(GeometryObject geomObj) {
		return getMultiPoint(geomObj, false);
	}
	...
	public MultiPointProperty getMultiPointProperty(GeometryObject geomObj) {
		return getMultiPointProperty(geomObj, false);
	}
	...
	public ControlPoint getControlPoint(GeometryObject geomObj) {
		return getControlPoint(geomObj, false);
	}
	...
	public CurveProperty getCurveProperty(GeometryObject geomObj) {
		return getCurveProperty(geomObj, false);
	}
	...
	public MultiCurve getMultiCurve(GeometryObject geomObj) {
		return getMultiCurve(geomObj, false);
	}
	...
	public MultiCurveProperty getMultiCurveProperty(GeometryObject geomObj) {
		return getMultiCurveProperty(geomObj, false);
	}
	...
	public List<LineStringSegmentArrayProperty> getListOfLineStringSegmentArrayProperty(GeometryObject geomObj) {
		return getListOfLineStringSegmentArrayProperty(geomObj, false);
	}
	...
	public GeometricComplex getPointOrCurveComplex(GeometryObject geomObj) {
		return getPointOrCurveComplex(geomObj, false);
	}
	...
	public GeometricComplexProperty getPointOrCurveComplexProperty(GeometryObject geomObj) {
		return getPointOrCurveComplexProperty(geomObj, false);
	}
	...
	public AbstractGeometry getPointOrCurveGeometry(GeometryObject geomObj) {
		return getPointOrCurveGeometry(geomObj, false);
	}
	...
	public GeometryProperty<? extends AbstractGeometry> getPointOrCurveGeometryProperty(GeometryObject geomObj) {
		return getPointOrCurveGeometryProperty(geomObj, false);
	}
	...
	public Polygon getPolygon(GeometryObject geomObj) {
		return getPolygon(geomObj, false);
	}
	...
	public PolygonProperty getPolygonProperty(GeometryObject geomObj) {
		return getPolygonProperty(geomObj, false);
	}
