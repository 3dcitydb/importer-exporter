...
public class CacheTableBasic extends CacheTableModel {
	...
	protected String getColumns(AbstractSQLAdapter sqlAdapter) {
		...
		.append("TABLE_NAME ").append(sqlAdapter.getCharacterVarying(64)).append(", ")
		.append("FROM_COLUMN ").append(sqlAdapter.getCharacterVarying(64)).append(", ")
		.append("TO_COLUMN ").append(sqlAdapter.getCharacterVarying(64)).append(", ")
