...
import org.citydb.citygml.common.database.cache.model.CacheTableTextureAssociation;
import org.citydb.citygml.common.database.cache.model.CacheTableTextureAssociationTarget;
import org.citydb.citygml.common.database.cache.model.CacheTableTextureCoordList;
import org.citydb.citygml.common.database.cache.model.CacheTableTextureFile;
import org.citydb.citygml.common.database.cache.model.CacheTableTextureFileId;
...
public class CacheTable extends AbstractCacheTable {	
	...
	public CacheTable(CacheTableModel model, Connection connection, AbstractSQLAdapter sqlAdapter) {
	...
	public void createAsSelect(String select) throws SQLException {
		if (isCreated)
			return;
