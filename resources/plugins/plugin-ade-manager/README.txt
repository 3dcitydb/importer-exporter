...
called "plugin-ade-manager-1.1.0.zip".
...
* Extract the downloaded ZIP file in the plugins folder. As a result a new
  folder named "plugin-ade-manager-1.1.0" will be created. This
...
the "plugin-ade-manager-1.1.0" subfolder and all its contents.
