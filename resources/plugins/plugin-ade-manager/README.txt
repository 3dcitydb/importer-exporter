...
called "plugin-ade-manager-1.1.2.zip".
...
* Extract the downloaded ZIP file in the plugins folder. As a result a new
  folder named "plugin-ade-manager-1.1.2" will be created. This
...
the "plugin-ade-manager-1.1.2" subfolder and all its contents.
