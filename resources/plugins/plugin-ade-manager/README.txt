...
version 4.2.0 of the 3D City Database Importer/Exporter.
...
called "plugin-ade-manager-1.1.1.zip".
...
* Open the installation directory of your local installation of the
  3D City Database Importer/Exporter version 4.2.0.
...
* Extract the downloaded ZIP file in the plugins folder. As a result a new
  folder named "plugin-ade-manager-1.1.1" will be created. This
...
the "plugin-ade-manager-1.1.1" subfolder and all its contents.
