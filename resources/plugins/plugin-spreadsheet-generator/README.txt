...
By using the Spreadsheet Generator Plugin, it is possible to export
data from a 3D City Database instance into tables. Supported output
...
version 4.1.0 of the 3D City Database Importer/Exporter.
...
called "plugin-spreadsheet-generator-3.1.0.zip".
...
* Open the installation directory of your local installation of the
  3D City Database Importer/Exporter version 4.1.0.
...
* Extract the downloaded ZIP file in the plugins folder. As a result a new
  folder named "plugin-spreadsheet-generator-3.1.0" will be created. This
...
the "plugin-spreadsheet-generator-3.1.0" subfolder and all its contents.
