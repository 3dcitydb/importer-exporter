...
-- CREATE INDEX GROUP_TO_CITYOBJECT_FKX ON GROUP_TO_CITYOBJECT (CITYOBJECT_ID, CITYOBJECTGROUP_ID);
...
-- CREATE INDEX OPENING_TO_THEM_SURFACE_FKX ON OPENING_TO_THEM_SURFACE (OPENING_ID, THEMATIC_SURFACE_ID);
...
-- CREATE INDEX RELIEF_FEAT_TO_REL_COMP_FKX ON RELIEF_FEAT_TO_REL_COMP (RELIEF_COMPONENT_ID, RELIEF_FEATURE_ID);
...
-- CREATE INDEX WATERBOD_TO_WATERBND_SRF_FKX ON WATERBOD_TO_WATERBND_SRF (WATERBOUNDARY_SURFACE_ID, WATERBODY_ID);
