...
CREATE OR REPLACE FUNCTION geodb_pkg.stat_table_contents() RETURNS text[] AS $$
  ...
  BEGIN
	...
	IF ws != 'LIVE' THEN
      ...
      report := array_append(report, ('Last refresh from LIVE workspace: ' || TO_CHAR(refreshDate, 'DD.MM.YYYY HH24:MI:SS'));
    END IF;
    */
