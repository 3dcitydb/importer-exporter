...
-- 2.0.2     2008-06-28   disable versioning before dropping          TKol	   FKun
-- 2.0.1     2008-06-28   also drop planning manager tables           GKoe
-- 2.0.0     2011-12-11   release version                             CNag
--                                                                    ASta
--
...
DROP TABLE ORTHOPHOTO_IMP CASCADE;

DROP TABLE ORTHOPHOTO CASCADE;

DROP TABLE RASTER_RELIEF_IMP CASCADE;
...
--\i DROP_PLANNING_MANAGER.sql

--\i DROP_GEODB_PKG.sql