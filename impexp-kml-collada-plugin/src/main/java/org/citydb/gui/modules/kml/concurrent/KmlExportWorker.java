 ...
 */
package org.citydb.gui.modules.kml.concurrent;
...
import org.citydb.gui.modules.kml.database.ColladaBundle;
import org.citydb.gui.modules.kml.database.KmlExporterManager;
import org.citydb.gui.modules.kml.database.KmlGenericObject;
import org.citydb.gui.modules.kml.database.KmlSplittingResult;
import org.citydb.gui.modules.kml.util.BalloonTemplateHandler;
import org.citydb.gui.modules.kml.util.ElevationServiceHandler;
...
public class KmlExportWorker extends Worker<KmlSplittingResult> {
	...
	private void doWork(KmlSplittingResult work) {
		...
		try {
			...
			if (Building.class.equals(objectClass)) {
				singleObject = new org.citydb.gui.modules.kml.database.Building(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.WaterBody(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.LandUse(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.SolitaryVegetationObject(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.PlantCover(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
					...
					|| Road.class.equals(objectClass)
					|| Square.class.equals(objectClass)) {
				singleObject = new org.citydb.gui.modules.kml.database.Transportation(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.Relief(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.GenericCityObject(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.CityFurniture(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.CityObjectGroup(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.Bridge(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.Tunnel(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
				...
				singleObject = new org.citydb.gui.modules.kml.database.ADEObject(connection,
						query,
						kmlExporterManager,
						kmlFactory,
						databaseAdapter,
