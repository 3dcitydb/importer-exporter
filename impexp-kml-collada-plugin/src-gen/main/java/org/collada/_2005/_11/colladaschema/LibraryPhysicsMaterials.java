...
public class LibraryPhysicsMaterials {
    ...
    public boolean isSetPhysicsMaterial() {
        return ((this.physicsMaterial!= null)&&(!this.physicsMaterial.isEmpty()));
    }

    public void unsetPhysicsMaterial() {
    ...
    public void setPhysicsMaterial(List<PhysicsMaterial> value) {
