...
public class Box {
    ...
    public boolean isSetHalfExtents() {
        return ((this.halfExtents!= null)&&(!this.halfExtents.isEmpty()));
    }

    public void unsetHalfExtents() {
    ...
    public void setHalfExtents(List<Double> value) {
        this.halfExtents = value;
    }
