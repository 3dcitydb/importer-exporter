...
@XmlType(name = "SimpleVisExportQueryType", propOrder = {
        "featureTypeFilter",
...
public class SimpleVisQuery {
    ...
    private VisTiling bboxFilter;

    public SimpleVisQuery() {
    ...
    public VisTiling getBboxFilter() {
        return bboxFilter;
    }
    ...
    public void setBboxFilter(VisTiling bboxFilter) {
