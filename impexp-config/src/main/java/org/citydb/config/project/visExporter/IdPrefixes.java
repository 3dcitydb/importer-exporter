...
public class IdPrefixes {
    @XmlTransient
    private final String PLACEMARK_FOOTPRINT_PREFIX = "KMLFootp_";
    @XmlTransient
    private final String PLACEMARK_EXTRUDED_PREFIX = "KMLExtr_";
    @XmlTransient
    private final String PLACEMARK_GEOMETRY_PREFIX = "KMLGeom_";
    @XmlTransient
    private final String PLACEMARK_HIGHLIGHT_PREFIX = "KMLGeomHi_";
    @XmlTransient
    private final String PLACEMARK_COLLADA_PREFIX = "COLLADA_";
