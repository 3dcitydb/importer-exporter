@ECHO OFF
REM Example shell script to execute the 3D City Database Importer/Exporter
...
REM Use '3dcitydb-impexp.jar -help' to get a list of available options
...
REM jar file.
REM %JAVA% -jar -Xms128m -Xmx768m lib/3dcitydb-impexp.jar %*

REM The following command executes the GUI version 
start /min cmd /c "%JAVA% -jar -Xms128m -Xmx768m lib/3dcitydb-impexp.jar"