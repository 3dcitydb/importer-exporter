...
public class ResourcesPanel extends InternalPreferencesComponent {
    ...
    public boolean isModified() {
        ...
        try {
            impResMinThreadsText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResMaxThreadsText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResTransaktFeatureText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResTransaktCacheText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResTransaktTempText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResGeomCacheText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResGeomDrainText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResGeomPartText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResFeatCacheText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResFeatDrainText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResFeatPartText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResTexCacheText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResTexDrainText.commitEdit();
        } catch (ParseException e) {
        }
        try {
            impResTexPartText.commitEdit();
        } catch (ParseException e) {
        }
