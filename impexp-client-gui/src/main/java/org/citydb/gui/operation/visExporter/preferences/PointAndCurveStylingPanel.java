...
public class PointAndCurveStylingPanel extends InternalPreferencesComponent {
    ...
    public boolean isModified() {
        ...
        if (pacSettings.getPointIconHighlightedColor() != pointIconHighlightingColorButton.getBackground().getRGB())
            return true;
        if (pacSettings.getPointIconHighlightedScale() != (Double) pointIconHighlightingScaleSpinner.getValue())
            return true;
        ...
        if (pacSettings.getPointCubeHighlightedColor() != pointCubeHighlightingColorButton.getBackground().getRGB())
            return true;
        if (pacSettings.getPointCubeHighlightedOutlineThickness() != (Double) pointCubeHighlightingLineThicknessSpinner.getValue())
            return true;
