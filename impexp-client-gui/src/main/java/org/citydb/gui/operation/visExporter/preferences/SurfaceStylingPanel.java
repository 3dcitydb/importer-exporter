...
public class SurfaceStylingPanel extends InternalPreferencesComponent {
    ...
    public boolean isModified() {
        try {
            geometryHLSurfaceDistanceText.commitEdit();
        } catch (ParseException ignored) {
        }
        try {
            colladaHLSurfaceDistanceText.commitEdit();
        } catch (ParseException ignored) {
        }
    ...
    public void switchLocale(Locale locale) {
        ...
        footprintDefaultStyleLabel.setText(Language.I18N.getString("pref.visExport.label.defaultStyle"));
        footprintFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
        footprintLineColorLabel.setText(Language.I18N.getString("pref.visExport.label.outlineColor"));
        footprintHighlightingCheckbox.setText(Language.I18N.getString("pref.visExport.label.highlightStyle"));
        footprintHLFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
        footprintHLLineColorLabel.setText(Language.I18N.getString("pref.visExport.label.outlineColor"));

        footprintFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        footprintLineColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseOutlineColor"));
        footprintHLFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        footprintHLLineColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseOutlineColor"));

        geometryDefaultStyleLabel.setText(Language.I18N.getString("pref.visExport.label.defaultStyle"));
        geometryFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
        geometryLineColorLabel.setText(Language.I18N.getString("pref.visExport.label.outlineColor"));
        geometryFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        geometryLineColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseOutlineColor"));

        if (showThematicSurfaceOptions) {
            geometryRoofStyleLabel.setText(Language.I18N.getString("pref.visExport.label.roofStyle"));
            geometryRoofFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
            geometryRoofLineColorLabel.setText(Language.I18N.getString("pref.visExport.label.outlineColor"));
            geometryRoofFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
            geometryRoofLineColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.outlineColor"));
        }

        geometryHLFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        geometryHLLineColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseOutlineColor"));
        geometryHighlightingCheckbox.setText(Language.I18N.getString("pref.visExport.label.highlightStyle"));
        geometryHLSurfaceDistanceLabel.setText(Language.I18N.getString("pref.visExport.label.highlightingDistance"));
        geometryHLFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
        geometryHLLineColorLabel.setText(Language.I18N.getString("pref.visExport.label.outlineColor"));

        colladaColorNote.setText(Language.I18N.getString("pref.visExport.label.colladaGltfColorSettings"));
        colladaDefaultStyleLabel.setText(Language.I18N.getString("pref.visExport.label.defaultStyle"));
        colladaFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
        colladaFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        colladaHLFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        colladaHLLineColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseOutlineColor"));

        if (showThematicSurfaceOptions) {
            colladaRoofStyleLabel.setText(Language.I18N.getString("pref.visExport.label.roofStyle"));
            colladaRoofFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
            colladaRoofFillColorButton.setDialogTitle(Language.I18N.getString("pref.visExport.label.chooseFillColor"));
        }

        colladaHighlightingCheckbox.setText(Language.I18N.getString("pref.visExport.label.colladaHighlightStyle"));
        colladaHLSurfaceDistanceLabel.setText(Language.I18N.getString("pref.visExport.label.highlightingDistance"));
        colladaHLFillColorLabel.setText(Language.I18N.getString("pref.visExport.label.fillColor"));
        colladaHLLineColorLabel.setText(Language.I18N.getString("pref.visExport.label.outlineColor"));
    }
