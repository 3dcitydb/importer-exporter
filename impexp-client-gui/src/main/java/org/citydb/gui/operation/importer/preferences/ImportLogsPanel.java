...
public class ImportLogsPanel extends InternalPreferencesComponent {
    ...
    public boolean isModified() {
        ...
        if (truncateFeatureLogFile.isSelected() != (featureLog.getLogFileMode() == ImportLogFileMode.TRUNCATE))
            return true;
        if (uniqueFeatureLogFileName.isSelected() != (featureLog.getLogFileMode() == ImportLogFileMode.UNIQUE))
            return true;
