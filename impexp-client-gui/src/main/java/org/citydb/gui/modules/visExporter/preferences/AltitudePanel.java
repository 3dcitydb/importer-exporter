...
public class AltitudePanel extends AbstractPreferencesComponent {
	...
	public boolean isModified() {
		...
		Elevation elevation = config.getVisExportConfig().getElevation();
	...
	public void doTranslation() {
		...
		modeComboBox.setSelectedItem(config.getVisExportConfig().getElevation().getAltitudeMode());
        modeLabel.setText(Language.I18N.getString("pref.visExport.altitude.label.mode"));
		noOffsetRadioButton.setText(Language.I18N.getString("pref.visExport.altitude.label.noOffset"));
		constantOffsetRadioButton.setText(Language.I18N.getString("pref.visExport.altitude.label.constantOffset"));
		bottomZeroRadioButton.setText(Language.I18N.getString("pref.visExport.altitude.label.bottomZero"));
		genericAttributeRadioButton.setText(Language.I18N.getString("pref.visExport.altitude.label.genericAttributeOffset"));
		callGElevationService.setText(Language.I18N.getString("pref.visExport.altitude.label.callGElevationService"));
		callGElevationServiceHint.setText(Language.I18N.getString("pref.visExport.altitude.label.callGElevationService.hint"));
		useOriginalZCoords.setText(Language.I18N.getString("pref.visExport.altitude.label.useOriginalZCoords"));
	}
