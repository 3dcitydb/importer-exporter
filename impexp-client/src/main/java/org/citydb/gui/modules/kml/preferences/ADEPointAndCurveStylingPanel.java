...
public class ADEPointAndCurveStylingPanel extends AbstractPreferencesComponent {
	...
	public ADEPointAndCurveStylingPanel(Config config, FeatureType adeTopLevelFeatureType) {
		super(config);
