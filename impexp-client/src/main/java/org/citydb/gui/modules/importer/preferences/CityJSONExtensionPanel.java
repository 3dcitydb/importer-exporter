...
import org.citydb.config.project.importer.CityJSONOptions;
...
public class CityJSONExtensionPanel extends AbstractPreferencesComponent {
	private TitledPanel mapUnknownExtensionsPanel;
	private JCheckBox mapUnknownExtensions;

	public CityJSONExtensionPanel(Config config) {
		super(config);
		initGui();
	}
	...
	public String getTitle() {
		return Language.I18N.getString("pref.tree.import.cityjson.extensions");
	}
