...
public class BalloonContentPanel extends AbstractPreferencesComponent {
	...
	public void doTranslation() {
		objectBalloon.titledPanel.setTitle(Language.I18N.getString("pref.kmlexport.balloon.border.createBalloon"));
		doTranslation(objectBalloon);

		if (showPointBalloon) {
			pointBalloon.titledPanel.setTitle(Language.I18N.getString("pref.kmlexport.balloon.border.createPointBalloon"));
			doTranslation(pointBalloon);
		}

		if (showCurveBalloon) {
			curveBalloon.titledPanel.setTitle(Language.I18N.getString("pref.kmlexport.balloon.border.createCurveBalloon"));
			doTranslation(curveBalloon);
		}
	}

	private void doTranslation(BalloonContext context) {
		context.useAttribute.setText(Language.I18N.getString("pref.kmlexport.balloon.label.genAttrib"));
		context.useFile.setText(Language.I18N.getString("pref.kmlexport.balloon.label.file"));
		context.useFallback.setText(Language.I18N.getString("pref.kmlexport.balloon.label.genAttribAndFile"));
		context.browseButton.setText(Language.I18N.getString("common.button.browse"));
		context.separateFile.setText(Language.I18N.getString("pref.kmlexport.balloon.label.contentInSeparateFile"));
	}
	...
	private void loadFile(Balloon balloon, JTextField browseText) {
		...
		fileChooser.setDialogTitle(Language.I18N.getString("pref.kmlexport.balloon.dialog.file"));
