...
public class CityObjectGroupBalloonPanel extends AbstractPreferencesComponent {
	...
	public void setSettings() {
		setInternBalloonValues();
		Balloon configBuildingBalloon = config.getProject().getKmlExporter().getCityObjectGroupBalloon();
		copyBalloonContents(internCityObjectGroupBalloon, configBuildingBalloon);
	}
