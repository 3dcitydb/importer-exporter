 ...
 */
package de.tub.citydb.components.matching.gui.preferences.components;
...
public class CandidatePanel extends AbstractPreferencesComponent {
	...
	public CandidatePanel(Config inpConfig) {
		super(inpConfig);
		initGui();
	}
	...
	public String getTitle() {
		return Internal.I18N.getString("pref.tree.matching.candidate");
	}
