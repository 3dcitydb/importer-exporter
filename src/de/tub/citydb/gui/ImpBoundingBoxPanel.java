...
public class ImpBoundingBoxPanel extends PrefPanelBase {
	...
	//Konstruktor
	public ImpBoundingBoxPanel(Config inpConfig) {
		super(inpConfig);
		initGui();
	}
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.import.boundingBox.border.selection")));
		impBBRadioInside.setText(ImpExpGui.labels.getString("pref.import.boundingBox.label.inside"));
		impBBRadioIntersect.setText(ImpExpGui.labels.getString("pref.import.boundingBox.label.overlap"));
	}
