...
public class SetLanguagePanel extends PrefPanelBase {
	...
	public SetLanguagePanel(Config inpConfig, ImpExpGui inpImpExpGui) {
		super(inpConfig);
	...
	public void doTranslation() {
		language.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.general.language.border.selection")));
		importLanguageRadioDe.setText(ImpExpGui.labels.getString("pref.general.language.label.de"));
		importLanguageRadioEn.setText(ImpExpGui.labels.getString("pref.general.language.label.en"));
	}
	...
	public void setSettings() {
		...
		if (importLanguageRadioDe.isSelected()) {
			...
			global.setLanguage(LanguageType.SYSTEM);
		}
