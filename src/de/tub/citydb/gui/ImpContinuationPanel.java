...
public class ImpContinuationPanel extends PrefPanelBase {
	...
	public ImpContinuationPanel(Config inpConfig) {
		super(inpConfig);
		initGui();
	}
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.import.continuation.border.lineage")));
		lineageLabel.setText(ImpExpGui.labels.getString("pref.import.continuation.label.lineage"));
		reasonForUpdateLabel.setText(ImpExpGui.labels.getString("pref.import.continuation.label.reasonForUpdate"));

		block2.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.import.continuation.border.updatingPerson")));
		updatingPersonDBAccount.setText(ImpExpGui.labels.getString("pref.import.continuation.label.updatingPerson.database"));
		updatingPersonUser.setText(ImpExpGui.labels.getString("pref.import.continuation.label.updatingPerson.user"));		
	}
