...
public class ExpResourcesPanel extends PrefPanelBase{
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("common.pref.resources.border.multiCPU")));
		expResMinThreadsLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.minThreads"));
		expResMaxThreadsLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.maxThreads"));

		block2.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("common.pref.resources.border.idCache")));
		expResGeomLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry"));
		expResGeomCacheLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry.entry"));
		expResGeomDrainLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry.drain"));
		expResGeomPartLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry.partition"));
		expResFeatLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature"));
		expResFeatCacheLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature.entry"));
		expResFeatDrainLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature.drain"));
		expResFeatPartLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature.partition"));
	}
