...
public class PrefPanel extends JPanel implements TreeSelectionListener {
	...
	private void initGui() {
		...
		expXLink = new DefaultMutableTreeNode("seehr langer Platzhalter");
	...
	public void doTranslation() {
		...
		expXLink.setUserObject(ImpExpGui.labels.getString("pref.tree.export.xlink"));
	...
	public void valueChanged(TreeSelectionEvent e) {
		...
		if (node == impContinuation){
			...
			col2panel.add(expXLinkPanel, BorderLayout.NORTH);
