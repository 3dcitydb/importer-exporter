...
public class MatchResultPanel extends PrefPanelBase {
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(Internal.I18N.getString("pref.matching.result.border")));
		resultFixRadio.setText(Internal.I18N.getString("pref.matching.result.fix"));
		resultUserRadio.setText(Internal.I18N.getString("pref.matching.result.user"));
		resultAllRadio.setText(Internal.I18N.getString("pref.matching.result.all"));
	}
