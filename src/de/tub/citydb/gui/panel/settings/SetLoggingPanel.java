...
public class SetLoggingPanel extends PrefPanelBase {
	...
	public SetLoggingPanel(Config config) {
		super(config);
		initGui();
	}
	...
	private void initGui() {
		...
		logPathButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String sExp = browseFile(logPathText.getText());
				if (!sExp.isEmpty())
		...
		setLayout(new GridBagLayout());
		{
			...
			{
				block1.add(logLevelConsoleLabel, GuiUtil.setConstraints(0,0,0.0,1.0,GridBagConstraints.BOTH,0,5,5,5));
				block1.add(logLevelConsoleCombo, GuiUtil.setConstraints(1,0,1.0,1.0,GridBagConstraints.BOTH,0,5,5,5));										
			}
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.general.logging.border.console")));
		logLevelConsoleLabel.setText(ImpExpGui.labels.getString("pref.general.logging.label.logLevel"));

		block2.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.general.logging.border.file")));	
		useLogFile.setText(ImpExpGui.labels.getString("pref.general.logging.label.useLogFile"));
		logLevelFileLabel.setText(ImpExpGui.labels.getString("pref.general.logging.label.logLevel"));
		useLogPath.setText(ImpExpGui.labels.getString("pref.general.logging.label.useLogPath"));
		logPathButton.setText(ImpExpGui.labels.getString("common.button.browse"));
	}
