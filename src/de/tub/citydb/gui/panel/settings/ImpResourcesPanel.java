...
public class ImpResourcesPanel extends PrefPanelBase{
	...
	public void doTranslation() {
		...
		impResMinThreadsLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.minThreads"));
		impResMaxThreadsLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.maxThreads"));
		...
		block3.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("common.pref.resources.border.idCache")));
		impResGeomLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry"));
		impResGeomCacheLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry.entry"));
		impResGeomDrainLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry.drain"));
		impResGeomPartLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.geometry.partition"));
		impResFeatLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature"));
		impResFeatCacheLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature.entry"));
		impResFeatDrainLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature.drain"));
		impResFeatPartLabel.setText(ImpExpGui.labels.getString("common.pref.resources.label.feature.partition"));
	}
