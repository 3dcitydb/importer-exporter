...
public class ImpIndexPanel extends PrefPanelBase implements PropertyChangeListener {	
	...
	public void doTranslation() {
		...
		block2.setBorder(BorderFactory.createTitledBorder(Internal.I18N.getString("pref.import.index.spatial.border.manual")));
		impSIDeactivate.setText(Internal.I18N.getString("pref.import.index.spatial.button.deactivate"));
		impSIActivate.setText(Internal.I18N.getString("pref.import.index.spatial.button.activate"));

		block3.setBorder(BorderFactory.createTitledBorder(Internal.I18N.getString("pref.import.index.normal.border.handling")));
		...
		block4.setBorder(BorderFactory.createTitledBorder(Internal.I18N.getString("pref.import.index.normal.border.manual")));
		impNIDeactivate.setText(Internal.I18N.getString("pref.import.index.normal.button.deactivate"));
		impNIActivate.setText(Internal.I18N.getString("pref.import.index.normal.button.activate"));
	}
	...
	private void dropIndex(DB_INDEX_TYPE type) {
		...
		try {
			...
			if (type == DB_INDEX_TYPE.SPATIAL) {
				...
				statusWindowTitle = Internal.I18N.getString("pref.import.index.spatial.dialog.window");
				statusTitle = Internal.I18N.getString("pref.import.index.spatial.dialog.deactivate");
				...
				statusWindowTitle = Internal.I18N.getString("pref.import.index.normal.dialog.window");
				statusTitle = Internal.I18N.getString("pref.import.index.normal.dialog.deactivate");
				logSuccess = "Deactivating normal indexes successfully finished.";
				logFail = "Deactivating normal indexes aborted.";
			}			

			String statusDetails = Internal.I18N.getString("pref.import.index.deactivate.detail");
			...
			try {
				...
				if (report != null)  {
					...
					if (dbSqlEx == null) {
						...
						String text = Internal.I18N.getString("pref.import.index.deactivate.error");
	...
	private void createIndex(DB_INDEX_TYPE type) {
		...
		try {
			...
			if (type == DB_INDEX_TYPE.SPATIAL) {
				...
				statusWindowsTitle = Internal.I18N.getString("pref.import.index.spatial.dialog.window");
				statusTitle = Internal.I18N.getString("pref.import.index.spatial.dialog.activate");
				...
				statusWindowsTitle = Internal.I18N.getString("pref.import.index.normal.dialog.window");
				statusTitle = Internal.I18N.getString("pref.import.index.normal.dialog.activate");
				logSuccess = "Activating normal indexes successfully finished.";
				logFail = "Activating normal indexes aborted.";
			}			

			String statusDetails = Internal.I18N.getString("pref.import.index.activate.detail");
			...
			try {
				...
				if (report != null)  {
					...
					if (dbSqlEx == null) {
						...
						String text = Internal.I18N.getString("pref.import.index.activate.error");
						Object[] args = new Object[]{ dbSqlEx };
						String result = MessageFormat.format(text, args);
