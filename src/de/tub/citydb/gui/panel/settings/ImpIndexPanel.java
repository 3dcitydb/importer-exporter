	...
	private void dropIndex(DB_INDEX_TYPE type) {
		...
		try {
			...
			if (type == DB_INDEX_TYPE.SPATIAL) {
				...
				statusWindowTitle = ImpExpGui.labels.getString("pref.import.index.spatial.dialog.window");
				statusTitle = ImpExpGui.labels.getString("pref.import.index.spatial.dialog.deactivate");
				...
				statusWindowTitle = ImpExpGui.labels.getString("pref.import.index.normal.dialog.window");
				statusTitle = ImpExpGui.labels.getString("pref.import.index.normal.dialog.deactivate");
				logSuccess = "Deactivating normal indexes successfully finished.";
				logFail = "Deactivating normal indexes aborted.";
			}			

			String statusDetails = ImpExpGui.labels.getString("pref.import.index.deactivate.detail");
	...
	private void createIndex(DB_INDEX_TYPE type) {
		...
		try {
			...
			if (type == DB_INDEX_TYPE.SPATIAL) {
				...
				statusWindowsTitle = ImpExpGui.labels.getString("pref.import.index.spatial.dialog.window");
				statusTitle = ImpExpGui.labels.getString("pref.import.index.spatial.dialog.activate");
				...
				statusWindowsTitle = ImpExpGui.labels.getString("pref.import.index.normal.dialog.window");
				statusTitle = ImpExpGui.labels.getString("pref.import.index.normal.dialog.activate");
				logSuccess = "Activating normal indexes successfully finished.";
				logFail = "Activating normal indexes aborted.";
			}			

			String statusDetails = ImpExpGui.labels.getString("pref.import.index.activate.detail");
