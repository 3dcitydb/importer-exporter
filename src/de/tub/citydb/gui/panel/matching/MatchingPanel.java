...
public class MatchingPanel extends JPanel implements PropertyChangeListener {	
	...
	public void doTranslation() {
		...
		row1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("match.step1.border")));
		row1_1.setText(ImpExpGui.labels.getString("match.step1.lodRef1"));
		row1_2.setText(ImpExpGui.labels.getString("match.step1.lodMer1"));
		row1_3.setText(ImpExpGui.labels.getString("match.step1.lineage"));
		tableCheck.setText(ImpExpGui.labels.getString("match.step1.tableCheck"));
		matchButton.setText(ImpExpGui.labels.getString("match.step1.button"));

		row2.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("match.step2.border")));
		row2_1.setText(ImpExpGui.labels.getString("match.step2.overlapOfMer"));
		row2_2.setText(ImpExpGui.labels.getString("match.step2.overlapOfRef"));
		row2_3.setText(ImpExpGui.labels.getString("match.step2.lodRef2"));
		row2_4.setText(ImpExpGui.labels.getString("match.step2.lodMer2"));
		row2_5.setText(ImpExpGui.labels.getString("match.step2.lineage"));
		lineage2Text.setToolTipText(ImpExpGui.labels.getString("match.step2.tooltip"));
		
		row2_6.setText(ImpExpGui.labels.getString("match.step2.setting"));
		createSettingText();
		
		mergeButton.setText(ImpExpGui.labels.getString("match.step2.button"));

		row3.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("match.tools.border")));
		row3_1.setText(ImpExpGui.labels.getString("match.tools.lineage"));
		deleteButton.setText(ImpExpGui.labels.getString("match.tools.delete"));
	}
	...
	public void createSettingText() {
		String prefixA = ImpExpGui.labels.getString("pref.matching.gmlName.short");
		String prefixB = ImpExpGui.labels.getString("pref.matching.delete.short");
		
		if (config.getProject().getMatching().getMatchingSettings().isGmlNameModeIgnore())
			settingsAText.setText("<html>" + prefixA + ": " + "<b>" + ImpExpGui.labels.getString("pref.matching.gmlName.ignore") + "</b></html>");
		else if (config.getProject().getMatching().getMatchingSettings().isGmlNameModeReplace())
			settingsAText.setText("<html>" + prefixA + ": " + "<b>" + ImpExpGui.labels.getString("pref.matching.gmlName.replace") + "</b></html>");
		else
			settingsAText.setText("<html>" + prefixA + ": " + "<b>" + ImpExpGui.labels.getString("pref.matching.gmlName.append") + "</b></html>");

		if (config.getProject().getMatching().getMatchingSettings().isDeleteModeDelAll())
			settingsBText.setText("<html>" + prefixB + ": " + "<b>" + ImpExpGui.labels.getString("pref.matching.delete.all") + "</b></html>");
		else if (config.getProject().getMatching().getMatchingSettings().isDeleteModeRename())
			settingsBText.setText("<html>" + prefixB + ": " + "<b>" + ImpExpGui.labels.getString("pref.matching.delete.rename") + "</b></html>");
		else 
			settingsBText.setText("<html>" + prefixB + ": " + "<b>" + ImpExpGui.labels.getString("pref.matching.delete.merge") + "</b></html>");
	}
