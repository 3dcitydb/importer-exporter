...
public class FilterPanel extends JPanel {
	...
	public void doTranslation() {
		...
		row4col22col2_1.setText(Internal.I18N.getString("filter.label.gmlName"));
		row3col2_1.setText(Internal.I18N.getString("filter.label.gmlId"));
		row4col21row1_1.setText(Internal.I18N.getString("filter.label.counter.start"));
		row4col21row1_2.setText(Internal.I18N.getString("filter.label.counter.end"));
		row4col23row2_1.setText(Internal.I18N.getString("filter.label.boundingBox.xMin"));
		row4col23row2_2.setText(Internal.I18N.getString("filter.label.boundingBox.xMax"));
		row4col23row2_3.setText(Internal.I18N.getString("filter.label.boundingBox.yMin"));
		row4col23row2_4.setText(Internal.I18N.getString("filter.label.boundingBox.yMax"));
		...
		srsLabel.setText(Internal.I18N.getString("filter.label.boundingBox.crs"));
		Object selectedSrid = srsComboBox.getSelectedItem();
		srsComboBox.removeAllItems();		
		for (FilterSRSType srid : FilterSRSType.values())
			srsComboBox.addItem(srid);
		
		srsComboBox.setSelectedItem(selectedSrid);
	}

	public void loadSettings() {
		FilterConfig filter = (type == FilterPanelType.IMPORT) ? 
				config.getProject().getImporter().getFilter() :
		...
		srsComboBox.setSelectedItem(filter.getComplexFilter().getBoundingBoxFilter().getSRS());
	...
	public void setSettings() {
		...
		filter.getComplexFilter().getBoundingBoxFilter().setSRS((FilterSRSType)srsComboBox.getSelectedItem());
