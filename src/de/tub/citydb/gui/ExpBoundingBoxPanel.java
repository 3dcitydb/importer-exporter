...
public class ExpBoundingBoxPanel extends PrefPanelBase {
	...
	//Konstruktor
	public ExpBoundingBoxPanel(Config inpConfig) {
		super(inpConfig);
		initGui();
	}
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.export.boundingBox.border.selection")));
		expBBRadioInside.setText(ImpExpGui.labels.getString("pref.export.boundingBox.label.inside"));
		expBBRadioIntersect.setText(ImpExpGui.labels.getString("pref.export.boundingBox.label.overlap"));
	}
