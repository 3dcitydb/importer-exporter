...
public class InfoDialog extends JDialog {
	...
	public InfoDialog(JFrame frame) {
		super(frame, ImpExpGui.labels.getString("menu.file.info.label"), true);
		initGUI();
	}

	private void initGUI() {
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		JButton button = new JButton(ImpExpGui.labels.getString("common.button.ok"));	
		...
		setLayout(new GridBagLayout()); {
			...
			header.setLayout(new GridBagLayout());
			{
				...
				if (this.getClass().getResource("/res/img/logo.png") != null) {
					JLabel img = new JLabel(new ImageIcon(getToolkit().getImage(this.getClass().getResource("/res/img/logo.png"))));
			...
			main.setLayout(new GridBagLayout());
			{
				...
				JLabel authorsHeader = new JLabel(ImpExpGui.labels.getString("menu.file.info.authors"));
