...
public class ReadMeDialog extends JDialog {
	...
	public ReadMeDialog(JFrame frame) {
		super(frame, ImpExpGui.labels.getString("menu.file.readMe.label"), true);
		initGUI();
	}
	...
	private void initGUI() {
		...
		setLayout(new GridBagLayout()); {
			...
			{
				JLabel readMeHeader = new JLabel(ImpExpGui.labels.getString("menu.file.readMe.information"));
				...
				try {
					BufferedReader in = new BufferedReader(
							new InputStreamReader(this.getClass().getResourceAsStream("/README")));
