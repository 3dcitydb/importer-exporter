...
public class ExpModulePanel extends PrefPanelBase {
	...
	public ExpModulePanel(Config inpConfig) {
		super(inpConfig);
	...
	public void doTranslation() {
		block1.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.export.module.border.versions")));		
		block2.setBorder(BorderFactory.createTitledBorder(ImpExpGui.labels.getString("pref.export.module.border.quickSelect")));		
	}
	...
	public void loadSettings() {
		...
		while (iter.hasNext()) {
			...
			for (CityGMLModuleVersion version : CityGMLModuleType.getModuleVersion(type))
