...
public class ExportStatusDialog extends JDialog implements EventListener {
	...
	private void initGUI(String impExpTitle, String impExpMessage) {
		...
		cancelButton = new JButton(ImpExpGui.labels.getString("common.button.cancel"));
		featureLabel = new JLabel(ImpExpGui.labels.getString("common.status.dialog.featureCounter"));
		textureLabel = new JLabel(ImpExpGui.labels.getString("common.status.dialog.textureCounter"));
		...
		{			
			...
			main.setLayout(new GridBagLayout());
			{
				...
				main.add(messageLabel, GuiUtil.setConstraints(0,1,0.0,0,GridBagConstraints.HORIZONTAL,5,5,0,5));
	...
	public void handleEvent(Event e) throws Exception {
		...
		if (e.getEventType() == EventType.Counter &&
			...
			messageLabel.setText(ImpExpGui.labels.getString("common.dialog.msg.abort"));
			progressBar.setIndeterminate(true);
		}
