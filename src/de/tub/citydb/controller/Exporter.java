...
public class Exporter implements EventListener {
	...
	public boolean doProcess() {
		...
		try {
			...
			eventDispatcher.triggerEvent(new StatusDialogMessage(ImpExpGui.labels.getString("export.dialog.cityObj.msg")));
			...
			eventDispatcher.triggerEvent(new StatusDialogMessage(ImpExpGui.labels.getString("export.dialog.finish.msg")));
