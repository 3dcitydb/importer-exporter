...
public class Exporter implements EventListener {
	...
	public boolean doProcess() {
		...
		try {
			...
			if (appearances.isSetExportAppearance() && appearances.isSetExportTextureFiles()) {
				// read user input
			...
			dbTempTableManager = new DBTempTableManager(dbPool, maxThreads);
			...
			try {		
				lookupServerManager.initServer(
						...
						new DBExportCache(dbTempTableManager, 
								DBTempTableModelEnum.GMLID_GEOMETRY, 
				...
				lookupServerManager.initServer(
						...
						new DBExportCache(dbTempTableManager, 
								DBTempTableModelEnum.GMLID_FEATURE, 
