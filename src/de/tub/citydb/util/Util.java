...
import de.tub.citygml4j.implementation.gml._3_1_1.CodeImpl;
...
public class Util {
	...
	public static <T extends Object> String collection2string(Collection<T> list, String delimiter) {
	...
	public static String[] gmlName2dbString(AbstractFeature feature, String delimiter) {
		...
		if (feature.getName() != null) {
			List<Code> codeList = feature.getName();
