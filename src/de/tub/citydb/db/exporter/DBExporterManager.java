...
import de.tub.citydb.db.cache.GmlIdLookupServer;
...
import de.tub.citygml4j.implementation.JAXBObjectFactory;
...
public class DBExporterManager {
	...
	public DBExporter getDBExporter(DBExporterEnum dbExporterType) throws SQLException {
		...
		if (dbExporter == null) {
			...
			case APPEARANCE:
				...
				break;
			case TEXTUREPARAM:
				dbExporter = new DBTextureParam(connection, cityGMLFactory, this);
				break;
			...
			case CITYOBJECTGROUP:
				...
				break;
			case GENERALIZATION:
				dbExporter = new DBGeneralization(connection, cityGMLFactory, exportFilter, this);
				break;
			case SDO_GEOMETRY:
	...
	public void print(CityGMLBase cityObject) throws JAXBException {
		...
		if (cityObject.getCityGMLClass() == CityGMLClass.APPEARANCE) {
			...
			case v0_4_0:
				org.citygml._0_4.AppearancePropertyType property040 = new org.citygml._0_4.AppearancePropertyType();
				property040.setAppearance(((de.tub.citygml4j.implementation.citygml.appearance._0_4.AppearanceImpl)appearance).getJAXBObject());
				featureProperty = JAXBObjectFactory.CITYGML_0_4.createAppearanceMember(property040);
				break;
			case v1_0_0:
				net.opengis.citygml.appearance._1.AppearancePropertyType property100 = new net.opengis.citygml.appearance._1.AppearancePropertyType();
				property100.setAppearance(((de.tub.citygml4j.implementation.citygml.appearance._1.AppearanceImpl)appearance).getJAXBObject());
				featureProperty = JAXBObjectFactory.APP_1.createAppearanceMember(property100);
				break;
			}
			...
			if (jaxbElem != null && jaxbElem.getValue() != null && jaxbElem.getValue() instanceof AbstractFeatureType) {
				...
				case v0_4_0:
					featureProperty =  JAXBObjectFactory.CITYGML_0_4.createCityObjectMember(featureProp);
					break;
				case v1_0_0:
					featureProperty =  JAXBObjectFactory.CORE_1.createCityObjectMember(featureProp);
					break;
				}
			}
		}
		...
		if (featureProperty != null) {
			marshaller.marshal(featureProperty, saxBuffer);
			ioWriterPool.addWork(saxBuffer.getEvents());
			saxBuffer.renew();
		}
	}
}
