...
public class DBCityFurniture implements DBImporter {
	...
	private boolean insert(CityFurniture cityFurniture, long cityFurnitureId) throws SQLException {
		...
		// gml:description
		if (cityFurniture.getDescription() != null) {
		...
		// citygml:class
		if (cityFurniture.getClazz() != null)
		...
		if (cityFurniture.getFunction() != null) {
			List<String> functionList = cityFurniture.getFunction();
			psCityFurniture.setString(6, Util.collection2string(functionList, " "));
		} else {
		...
		for (int lod = 1; lod < 5; lod++) {
			...
			switch (lod) {
			case 1:
				multiCurveProperty = cityFurniture.getLod1TerainIntersection();
				break;
			case 2:
				multiCurveProperty = cityFurniture.getLod2TerainIntersection();
				break;
			case 3:
				multiCurveProperty = cityFurniture.getLod3TerainIntersection();
				break;
			case 4:
				multiCurveProperty = cityFurniture.getLod4TerainIntersection();
				break;
			}
