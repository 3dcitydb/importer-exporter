...
public class DBTrafficArea implements DBImporter {
	...
	public long insert(TrafficArea trafficArea, long parentId) throws SQLException {
		...
		// gml:description
		if (trafficArea.getDescription() != null) {
		...
		if (trafficArea.getFunction() != null) {
			List<String> functionList = trafficArea.getFunction();
			psTrafficArea.setString(6, Util.collection2string(functionList, " "));
		} else {
		...
		if (trafficArea.getUsage() != null) {
			List<String> usageList = trafficArea.getUsage();
			psTrafficArea.setString(7, Util.collection2string(usageList, " "));
		} else {
			psTrafficArea.setNull(7, Types.VARCHAR);
		}

		// surface material
		if (trafficArea.getSurfaceMaterial() != null)
	...
	public long insert(AuxiliaryTrafficArea auxiliaryTrafficArea, long parentId) throws SQLException {
		...
		// gml:name
		if (auxiliaryTrafficArea.getName() != null) {
		...
		// gml:description
		if (auxiliaryTrafficArea.getDescription() != null) {
		...
		// citygml:function
		if (auxiliaryTrafficArea.getFunction() != null) {
			List<String> functionList = auxiliaryTrafficArea.getFunction();
			psTrafficArea.setString(6, Util.collection2string(functionList, " "));
		} else {
			psTrafficArea.setNull(6, Types.VARCHAR);
		}
		...
		// surface material
		if (auxiliaryTrafficArea.getSurfaceMaterial() != null)
