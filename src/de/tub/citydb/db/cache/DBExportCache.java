...
public class DBExportCache implements DBCacheModel {
	...
	public DBExportCache(DBTempTableManager tempTableManager, DBTempTableModelEnum backupTableType, int partitions, int batchSize) throws SQLException {
		this.partitions = partitions;

		DBTempGTT main = tempTableManager.createIndexedGTT(new DBTempTableIdCache(backupTableType));
