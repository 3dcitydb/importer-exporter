...
public class DBGmlIdResolver {
	...
	private void init() throws SQLException {
		...
		psSurfaceGeometryId = commitConn.prepareStatement("select ID " + sqlGeometryFromClause + " order by id");
	...
	private GmlIdEntry serverLookup(String gmlId, GmlIdEntry oldEntry, GmlIdLookupServer lookupServer) {
		...
		// here, e.g. if we want to correctly resolve a orientable surface
