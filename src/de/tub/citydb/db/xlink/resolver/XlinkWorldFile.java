        ...
        if (worldFileName != null) {
            ...
            for (String fileName : fileList) {
                ...
                resolverManager.propagateEvent(new LogMessageEvent(
                		"Verarbeite World File: " + worldFile,
                ...
                try {
                    ...
                    if (content.size() == 6) {
                    	...
                    	JGeometry geom = new JGeometry(content.get(4), content.get(5), Integer.valueOf(dbSrid));
                    	...
                    	resolverManager.propagateEvent(new LogMessageEvent(
                        		"Fehler beim Import des World Files '" + worldFile +"':  Inhalt konnte nicht interpretiert werden.",
                        		LogMessageEnum.INFO
                        ));
                    }
                	...
                	resolverManager.propagateEvent(new LogMessageEvent(
                    		"Fehler beim Import des World Files '" + worldFile +"': " + fnfe,
                    		LogMessageEnum.INFO
                    ));
                	...
                	resolverManager.propagateEvent(new LogMessageEvent(
                    		"Fehler beim Import des World Files '" + worldFile +"': " + ioe,
                    		LogMessageEnum.INFO
                    ));
