...
public class FilterPanel extends JPanel implements EventHandler {
	...
	private void setEnabledFilterSettings() {
		...
		boolean isSupported = config.getProject().getExporter().getCityGMLVersion() == CityGMLVersionType.v2_0_0;
	...
	public void loadSettings() {
		AbstractFilterConfig filterConfig = config.getProject().getExporter().getFilter();
	...
	public void handleEvent(Event event) throws Exception {
		...
		if (featureClassFilter.isSelected() && e.getPropertyName().equals("citygml.version")) {
